...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "coachersir-1045";

  private static final DeviceInfoEndpoint devicesEndpoint = new DeviceInfoEndpoint();
  ...
  @ApiMethod(name = "listMessages", path="list")
  ...
  public void sendMessage(@Named("message") String message)
    ...
    CollectionResponse<DeviceInfo> response = devicesEndpoint.listDeviceInfo(null,
        10);
  ...
  private static Result doSendViaGcm(String message, Sender sender,
    ...
    if (result.getMessageId() != null) {
      ...
      if (canonicalRegId != null) {
        devicesEndpoint.removeDeviceInfo(deviceInfo.getDeviceRegistrationID());
        deviceInfo.setDeviceRegistrationID(canonicalRegId);
        devicesEndpoint.insertDeviceInfo(deviceInfo);
      }
    } else {
