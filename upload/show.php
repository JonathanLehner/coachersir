...
<form>
    <div id="preview">
        <a href="http://content.bitsontherun.com/previews/<?php echo $video_key?>-ALJ3XQCI"
            style="background:url(http://content.bitsontherun.com/thumbs/<?php echo $video_key?>-120.jpg)"
