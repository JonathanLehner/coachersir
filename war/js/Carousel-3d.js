 ...
 * angular-carousel-3d
 *
 * Version: 0.0.7 - 2015-12-08T10:50:49.549Z
 * License: MIT
 */
...
(function () {
    ...
    // ========================================
    Carousel3dController.$inject = ['$scope', '$element', '$attrs','videoService', '$timeout', '$log', '$parse', 'Carousel3dService'];

    function Carousel3dController($scope, $element, $attrs, videoService,$timeout, $log, $parse, Carousel3dService) {
        var vm = this;
...
(function () {
    ...
    function carousel3d($timeout) {
        ...
        var carousel3d = {
            ...
            '        <div class="carousel-item" ng-repeat=\"image in vm.slides track by $index\" class=\"slide-3d\" ng-click=\"vm.slideClicked($index)\" ng-swipe-left=\"vm.goPrev()\" ng-swipe-right=\"vm.goNext()\">'+
            '           <div class="player">'+
            '           <img src="img/player.png" border="0" alt>' +
            '           </div>'+
            '           <img  ng-src=\"{{image[vm.sourceProp]}}\" >' +
            '       </div>'+
            '       </div>' +
...
(function () {
    ...
    function Carousel3dService($rootScope, $q, $log) {
        ...
        function Carousel3d(slides, params) {
            ...
            this.sourceVideo = params.sourceVideo || 'videoRef';
